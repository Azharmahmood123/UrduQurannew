...
public class ServiceDownloadWBW extends Service implements UnzipListenerWBW {
    ...
    public void onCreate() {
        ...
        mDownloadingDuasPref = new DownloadingWBWPref(this);
    ...
    public String getUrl() {
        ...
        String url;
        String urlAsia = "https://storage.googleapis.com/quran_urdu_as/surahs/Surahs.zip";
        String urlUS = "https://storage.googleapis.com/quran_urdu_eu/surahs/Surahs.zip";
        String urlEU = "https://storage.googleapis.com/quran_urdu_us/surahs/Surahs.zip";
    ...
    private BroadcastReceiver downloadReceiver = new BroadcastReceiver() {
        ...
        public void onReceive(Context context, Intent intent) {
            ...
            if (checkDownloadStatus(referenceId)) {
                ...
                mUnZipUtil.setListener(ServiceDownloadWBW.this);
                mUnZipUtil.execute();
            }
        }
    };
    ...
    public void unzipStatus(boolean status) {
        ...
        if (status) {
            Intent intent = new Intent(ACTION_WBW_AUDIO_DOWNLOAD_COMPLETED);
        ...
        if(settingPrefs.isAppActive()) {
            final  Toast toast=Toast.makeText(this, "Word By Word audio files download is Completed", Toast.LENGTH_SHORT);
