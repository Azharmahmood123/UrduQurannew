...
public class ServiceDownloadQuranVocabulary extends Service implements UnzipListenerQuranVocabulary {
    public static final String ACTION_QURANVOCABULARY_AUDIO_DOWNLOAD_COMPLETED = "action.images.completed";

    DownloadingQuranVocabularyPref mDownloadingDuasPref;
    ...
    public void onCreate() {
        ...
        mDownloadingDuasPref = new DownloadingQuranVocabularyPref(this);
    ...
    private void downloadDuas() {
        ...
        request.setDestinationInExternalPublicDir(DownloadUtilsQuranVocabulary.rootFolderQuranVocabulary, DownloadUtilsQuranVocabulary.QuranVocabulary_ZIP_TEMP);
    ...
    public String getUrl() {
        ...
        String url;
        String  urlAsia = "https://storage.googleapis.com/quran_urdu_as/vocubulary/AudiosQuranVocabulary.zip";
        String  urlUS = "https://storage.googleapis.com/quran_urdu_eu/vocubulary/AudiosQuranVocabulary.zip";
        String  urlEU = "https://storage.googleapis.com/quran_urdu_us/vocubulary/AudiosQuranVocabulary.zip";
    ...
    private BroadcastReceiver downloadReceiver = new BroadcastReceiver() {
        ...
        public void onReceive(Context context, Intent intent) {
            ...
            if (checkDownloadStatus(referenceId)) {
                ...
                mUnZipUtil.setListener(ServiceDownloadQuranVocabulary.this);
                mUnZipUtil.execute();
            }
        }
    };
    ...
    public void unzipStatus(boolean status) {
        ...
        if (status) {
            Intent intent = new Intent(ACTION_QURANVOCABULARY_AUDIO_DOWNLOAD_COMPLETED);
            ...
            if(!EnoughMemory(Double.parseDouble(getString(R.string.Quranvocabulary_audioSize))))
            {
                ...
                final  Toast toast=Toast.makeText(this,"Quran Vocabulary downloading failed,try again!",Toast.LENGTH_SHORT);
        ...
        if(settingPrefs.isAppActive()) {
            final Toast toast=Toast.makeText(this, "Quran Vocabulary audio files " + " " + getString(R.string.downloadCompleted), Toast.LENGTH_SHORT);
            toast.setGravity(Gravity.CENTER,0,0);
            toast.show();
    ...
    private void showMemoryLowDialog() {
        ...
        builder.setMessage("You have insufficient storage, 100Mb is required. Please Try again.");
