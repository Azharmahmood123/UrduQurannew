...
public class DownloadUtilsQuranVocabulary {
    ...
    public static  String rootFolderQuranVocabulary = "QuranNow/QuranVocabulary/";
    public static  String QuranVocabulary_ZIP_TEMP = "temp_AudiosQuranVocabulary.zip";
    public static final File rootPathQuranVocabulary = new File(Environment.getExternalStorageDirectory(), rootFolderQuranVocabulary);
    ...
    public static void deleteAudioFile(String fileName) {
        File tempFile = new File(DownloadUtilsQuranVocabulary.rootPathQuranVocabulary.getAbsolutePath(), fileName);
